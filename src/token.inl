...
TOKEN(TOKEN_PLUS) TOKEN(TOKEN_PLUS_EQUAL)
TOKEN(TOKEN_MINUS) TOKEN(TOKEN_MINUS_EQUAL)
TOKEN(TOKEN_STAR) TOKEN(TOKEN_STAR_EQUAL)
TOKEN(TOKEN_SLASH) TOKEN(TOKEN_SLASH_EQUAL)
