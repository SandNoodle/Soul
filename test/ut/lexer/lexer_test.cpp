...
TEST_F(LexerTest, Keywords)
{
	...
	const char* str = "native import define fn let mut if else for while "
	                  "continue break struct enum true false";
	result_array    = scan_string(str);

	soul_token_type_t expected_types[soul_token_keywords_size] = {
	    soul_token_native,   soul_token_import, soul_token_define,
	    soul_token_let,      soul_token_mut,    soul_token_if,
	    soul_token_else,     soul_token_for,    soul_token_while,
	    soul_token_continue, soul_token_break,  soul_token_return,
	    soul_token_fn,       soul_token_struct, soul_token_enum,
	...
	{
		const soul_token_type_t actual_type
		    = soul_token_array_type_at(&result_array.tokens, i);
...
TEST_F(LexerTest, Literals_Strings)
{
	...
	const char* expected_strings[expected_count] = {"\"test string\"", ""};
	ASSERT_EQ(result_array.size, ARRAY_SIZE(expected_strings));
